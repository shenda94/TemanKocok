...
import model.OnLoadMorePeriode;
import model.PeriodeAdapter;
import model.PeriodeModel;
...
public class PeriodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            //pDialog = new ProgressDialog(this, R.style.ProgressBar);
            tvEmptyView = (TextView) findViewById(R.id.empty_viewpr);
            mRecyclerView = (RecyclerView) findViewById(R.id.my_recycler_viewpr);
            handler = new Handler();
            modeldataList = new ArrayList<PeriodeModel>();
            ...
            gabung = AppVar.DATA_URL_periode + requestCount + "&id_user=" + id_user + "&id_group_arisan=" + id_group_arisan;
            ...
            load_data_first();
            mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipeRefreshLayoutpr);
            ...
            Toast.makeText(PeriodeActivity.this, "Error: stu7 " + e.toString(), Toast.LENGTH_LONG).show();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_bookmark) {
            ...
            editor.putString(AppVar.ID_PERIODE_SHARED_PR, "");
            editor.putString(AppVar.NAMA_PERIODE_SHARED_PR, "");
            editor.putString(AppVar.NOMINAL_PERIODE_SHARED_PR, "");
            editor.putString(AppVar.ID_GROUPARISAN_SHARED_PR, "");
            editor.putString(AppVar.ID_USER_SHARED_PR, "");
            editor.putString(AppVar.TGLPERIODE_SHARED_PR, "");
            editor.putString(AppVar.TGLJADWALKOCOK_SHARED_PR, "");
            editor.commit();

            startActivity(new Intent(PeriodeActivity.this,TambahPeriodeActivity.class));
            //return true;
        }
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            if (response.length() > 0) {
                                for (int i = 0; i < response.length(); i++) {
                                    ...
                                    if (person.getInt("statuspesan") == 1){
                                        ...
                                        modeldataList.add(new PeriodeModel(id_periode, nama_periode,statusselesai,tgl_periode,nama_group_arisan,nominal,tgl_jadwalkocok));
                                    }
                                }
                            ...
                            hideDialog();
                            e.printStackTrace();
                            Toast.makeText(PeriodeActivity.this,
                                    "Error: " + e.getMessage(),
    ...
    public void progresafter() {
        try {
            ...
            mAdapter = new PeriodeAdapter(modeldataList, mRecyclerView);
            ...
            mAdapter.setOnLoadMoreListener(new OnLoadMorePeriode() {
                @Override
                public void onLoadMorePeriode() {
            ...
            Toast.makeText(PeriodeActivity.this, "Error: stu" + e.toString(), Toast.LENGTH_LONG).show();
        }
    }

    private void onscrolldatax(int start) {
        //Toast.makeText(getActivity(), "test"+kodeunker, Toast.LENGTH_SHORT).show();
        gabung = AppVar.DATA_URL_periode + start + "&id_user=" + id_user + "&id_group_arisan=" + id_group_arisan;
