...
import model.OnLoadMorePilihKocok;
import model.PilihKocokanAdapter;
import model.PilihKocokanModel;

public class PilihKocokanActivity extends AppCompatActivity {
    private TextView tvEmptyView;
    private RecyclerView mRecyclerView;
    private PilihKocokanAdapter mAdapter;
    ...
    String id_group_arisan, id_user, id_userag;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pilih_kocokan);

        SharedPreferences sharedPreferences1 = getSharedPreferences(AppVar.SHARED_PREF_PILIHUSRPERIODE, Context.MODE_PRIVATE);
        id_userag  = sharedPreferences1.getString(AppVar.ID_userPM_SHARED, "");
        ...
        try {
            ...
            handler = new Handler();
            modeldataList = new ArrayList<PilihKocokanModel>();

            gabung = AppVar.DATA_URL_jadwal1 + requestCount + "&id_user=" + id_user + "&id_group_arisan=" + id_group_arisan;
            ...
            Toast.makeText(PilihKocokanActivity.this, "Error: stu7 " + e.toString(), Toast.LENGTH_LONG).show();
        }
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        PilihKocokanActivity.this.finish();
                    }
                });
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            if (response.length() > 0) {
                                for (int i = 0; i < response.length(); i++) {
                                    ...
                                    if (person.getInt("statuspesan") == 1){
                                        ...
                                        String id_kocokannama = person.getString("id_kocokan_nama");
                                        String nama_kocokan = person.getString("nm_kocokan");

                                        modeldataList.add(new PilihKocokanModel( id_user,  id_group_arisan,  id_kocokannama,  nama_kocokan));
                                    }
                                }
                            ...
                            hideDialog();
                            e.printStackTrace();
                            Toast.makeText(PilihKocokanActivity.this,
                                    "Error: " + e.getMessage(),
    ...
    public void progresafter() {
        try {
            ...
            mAdapter = new PilihKocokanAdapter(modeldataList, mRecyclerView);
            ...
            mAdapter.setOnLoadMoreListener(new OnLoadMorePilihKocok() {
                @Override
                public void onLoadMorePilihKocok() {
            ...
            Toast.makeText(PilihKocokanActivity.this, "Error: stu" + e.toString(), Toast.LENGTH_LONG).show();
        }
    }
