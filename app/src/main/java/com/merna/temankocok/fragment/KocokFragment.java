...
import model.KocokAdapter;
import model.KocokModel;
import model.OnLoadMoreKocok;

public class KocokFragment extends Fragment {
    private TextView tvEmptyView;
    private RecyclerView mRecyclerView;
    private KocokAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.kocok_fragment,container,false);
        try {
            pDialog = new ProgressDialog(getActivity(), R.style.ProgressBar);
            tvEmptyView = (TextView) v.findViewById(R.id.empty_view_k1);
            mRecyclerView = (RecyclerView) v.findViewById(R.id.my_recycler_view_k1);
            handler = new Handler();
            modeldataList = new ArrayList<KocokModel>();
            ...
            gabung = AppVar.DATA_URLK + requestCount + "&id_group_arisan=" + id_group_arisan;
            ...
            mSwipeRefreshLayout = (SwipeRefreshLayout) v.findViewById(R.id.swipeRefreshLayout_k1);
                        ...
                        try {
                            ...
                            if (response.length() > 0) {
                                for (int i = 0; i < response.length(); i++) {
                                    ...
                                    //KocokModel(String id_group_arisan, String id_kocokan_nama, String nama_group_arisan, String nm_kocokan, String id_user, String nama_user, String statussleesai)

                                    //(String id_group_arisan, String nama_group_arisan, String id_anggota, String id_user, String nama_user, String statusanggota
                                    if (person.getInt("statuspesan") == 1){
                                        ...
                                        modeldataList.add(new KocokModel(id_group_arisan, id_kocokan_nama,nama_group_arisan,nm_kocokan,id_user,nama_user,statussleesai));
                                    }
    ...
    public void progresafter() {
        try {
            ...
            mAdapter = new KocokAdapter(modeldataList, mRecyclerView);
            ...
            mAdapter.setOnLoadMoreListener(new OnLoadMoreKocok() {
                @Override
                public void onLoadMoreKocok() {
    ...
    private void onscrolldatax(int start) {
        ...
        gabung = AppVar.DATA_URLK + start + "&id_group_arisan=" + id_group_arisan;
