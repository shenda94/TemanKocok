...
import model.OnloadMorePilihGroup;
import model.PilihGroupAdapter;
import model.PilihGroupModel;
...
public class DafGroupActivity extends AppCompatActivity {
    private TextView tvEmptyView;
    private RecyclerView mRecyclerView;
    private PilihGroupAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daf_group);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        try {
            pDialog = new ProgressDialog(this, R.style.ProgressBar);
            tvEmptyView = (TextView) findViewById(R.id.empty_viewpilih);
            mRecyclerView = (RecyclerView) findViewById(R.id.my_recycler_viewpilih);
            handler = new Handler();
            modeldataList = new ArrayList<PilihGroupModel>();
            ...
            gabung = AppVar.DATA_URL1 + requestCount + "&id_user=" + id_user;
            ...
            mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipeRefreshLayoutpilih);
            ...
            Toast.makeText(DafGroupActivity.this, "Error: stu7 " + e.toString(), Toast.LENGTH_LONG).show();
        }
    }
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            if (response.length() > 0) {
                                for (int i = 0; i < response.length(); i++) {
                                    ...
                                    if (person.getInt("statuspesan") == 1){
                                        ...
                                        modeldataList.add(new PilihGroupModel(id_surat,tgl_surat,jenis_surat,nomor_surat));
                                    }
                                }
                            ...
                            hideDialog();
                            e.printStackTrace();
                            Toast.makeText(DafGroupActivity.this,
                                    "Error: " + e.getMessage(),
    ...
    public void progresafter() {
        try {
            ...
            mAdapter = new PilihGroupAdapter(modeldataList, mRecyclerView);
            ...
            mAdapter.setOnLoadMoreListener(new OnloadMorePilihGroup() {
                @Override
                public void onLoadMorePilihGroup() {
            ...
            Toast.makeText(DafGroupActivity.this, "Error: stu" + e.toString(), Toast.LENGTH_LONG).show();
        }
    }

    private void onscrolldatax(int start) {
        //Toast.makeText(getActivity(), "test"+kodeunker, Toast.LENGTH_SHORT).show();
        gabung = AppVar.DATA_URL1 + start + "&id_user=" + id_user;
