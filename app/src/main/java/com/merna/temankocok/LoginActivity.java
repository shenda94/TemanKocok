...
public class LoginActivity extends AppCompatActivity {
    ...
    private String codepattern, Pincode, nmuser;
...
//Getting values from edit texts
        SharedPreferences sharedPreferences = getSharedPreferences(AppVar.SHARED_PREF_NAMAUSER, Context.MODE_PRIVATE);
        nmuser = sharedPreferences.getString(AppVar.NAMAUSER_HRF, "");
        //Toast.makeText(context, "tess " + nmuser, Toast.LENGTH_LONG).show();
...
//If we are getting success from server
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                editor.putString(AppVar.NAMA_SHARED_PENGGUNA, nm_lengkap1);
...
//Adding parameters to request
                ...
                params.put(AppVar.log_imei, "0");
                params.put(AppVar.user_pattern, nmuser);
//returning parameter
                return params;
            }
        };
